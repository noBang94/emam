...
<div class="page-wrapper">
    ...
    <div class="top-bar">
        ...
        <div class="btn-container">
            <button id="backBtn" class="back-btn"><i class="fas fa-arrow-left"></i> 뒤로 가기</button>
            ...
            <div class="search-container">
                <form action="<%=request.getContextPath() %>/admin/userList.do" method="get" class="form-inline">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="searchId" name="searchId" value="<%= request.getParameter("searchId") != null ? request.getParameter("searchId") : "" %>" placeholder="검색할 아이디를 입력하세요">
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="delete-btn" onclick="deleteUser('<%= member.getMem_id() %>')">
