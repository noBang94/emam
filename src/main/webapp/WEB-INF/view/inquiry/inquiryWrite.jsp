...
<body>
<h3><i class="fas fa-pen"></i> 문의하기</h3>
<div id="main">
  <form id="mainForm" action="<%=request.getContextPath()%>/inquiry/inquiryWrite.do">
    ...
    <table class="mainTable">
      <tr>
        <td>문의 제목</td>
        <td>
          <input type="text" id="title" name="inquiry_title" placeholder="제목을 입력하세요">
        </td>
      </tr>
      <tr>
        <td>문의 내용</td>
        <td>
          <textarea id="con" name="inquiry_con" placeholder="문의 내용을 상세히 입력해주세요"></textarea>
        </td>
      </tr>
      <tr>
        <td>공개 여부</td>
